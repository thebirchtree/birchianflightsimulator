...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
	...
	public class Movement2 : MonoBehaviourPun
	{
		...
		void Update()
		{
			...
			{
				TakeInput (RollInput,PitchInput,YawInput,ThrottleInput,AirBrakes);
			}
		}
		public void TakeInput(float rollInput, float pitchInput, float yawInput, float throttleInput, bool airBrakes)
		{ 
