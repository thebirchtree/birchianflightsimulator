...
public class FIREMISSILE2 : MonoBehaviour {
	...
	public void FixedUpdate () {
		...
		if (jetType.tag == "Player2" && Input.GetButton (",")) 
			ConsiderFiring ();
		 { 
			// If this gun doesn't belong to the player, it must belong to an enemy
			// Shoot a raycast out from the gun to determine whether its aim is near the play
